<div class="col-md-2 dashboard-sidebar col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a hef="home.html">
                        <img src="./Assets/Images/book.gif" alt="Logo" class="visible-xs visible-sm circle-logo" width="50">
                    </a>
